...
namespace Yelo.Api.Filters
{
    ...
    public class GenericAuthenticationFilter : AuthorizationFilterAttribute
    {
        ...
        public override void OnAuthorization(HttpActionContext filterContext)
        {
            ...
            if (!OnAuthorizeUser(identity.Name, identity.PhoneNumber, filterContext))
            {
                ChallengeAuthRequest(filterContext);
                return;
            }
        ...
        /// <param name="filterContext"></param>  
        /// <returns></returns>  
        protected virtual bool OnAuthorizeUser(string user, string phoneNumber, HttpActionContext filterContext)
        {
            if (string.IsNullOrEmpty(user) || phoneNumber != null) return false;
            return true;
        }
